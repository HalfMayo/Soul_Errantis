    ...
    <Section id="story" ref={ref}>
      <div className="flex flex-col items-center justify-center sm:w-2/4 w-[90%] gap-6">
        ...
        <p className="text-center sm:w-full w-[85%]">
          ...
          Sed feugiat eros eget ipsum volutpat, vitae dictum nunc vestibulum.
          Nam consequat, leo ut convallis ornare, purus orci scelerisque arcu,
          nec cursus dui orci a orci. Duis interdum aliquam ligula, at aliquam
          metus gravida id. Fusce rhoncus odio fringilla ex consequat iaculis
          vel at augue. Aenean bibendum ac velit a dictum. Proin sapien nulla,
          pharetra egestas semper sit amet, porttitor sit amet erat. Phasellus
          in eleifend leo, vitae semper ante. Quisque condimentum neque eu
          porttitor vestibulum. Cras porta hendrerit mi non laoreet.
        </p>
